...
@section('page_title', 'Pievienot grāmatu')
@section('title', 'Pievienot grāmatu — Mazo bibliotēku sistēma')
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-200">
        <div class="px-6 py-5 border-b border-slate-100">
            <div class="flex items-center gap-3">
                ...
                <h3 class="text-lg font-semibold text-slate-800">Pievienot grāmatu</h3>
            </div>
        </div>
        <form action="{{ route('books.store') }}" method="POST" class="p-6 space-y-5">
            @csrf
